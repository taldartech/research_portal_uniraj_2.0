...
class CourseworkExemptionRejected extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        $remarks = $this->courseworkExemption->remarks ?? 'No specific remarks provided.';

        return (new MailMessage)
                    ->subject('Coursework Exemption Rejected')
                    ->greeting('Hello ' . $scholarName . ',')
                    ->line('Your request for coursework exemption has been rejected by the Dean.')
                    ->line('Reason: ' . $reason)
