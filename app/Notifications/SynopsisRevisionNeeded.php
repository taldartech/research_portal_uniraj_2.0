...
class SynopsisRevisionNeeded extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        $feedback = $this->synopsis->remarks ?? 'No specific feedback provided.';

        return (new MailMessage)
                    ->subject('Synopsis Revision Needed')
                    ->greeting('Hello ' . $scholarName . ',')
                    ->line('Your proposed synopsis requires revisions from the DRC.')
                    ...
                    ->line('Please make the necessary revisions and resubmit your synopsis.')
