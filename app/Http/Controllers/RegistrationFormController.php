...
class RegistrationFormController extends Controller
{
    ...
    public function generateRegistrationForm(Scholar $scholar)
    {
        ...
        if (Auth::user()->user_type !== 'da') {
            abort(403, 'Only Dealing Assistant can generate registration forms.');
        }
    ...
    */
    ...
    public function listRegistrationForms()
    {
        // Check if user is DA
        if (Auth::user()->user_type !== 'da') {
            abort(403, 'Only Dealing Assistant can view registration forms.');
        }
    ...
    public function listEligibleScholars()
    {
        // Check if user is DA
        if (Auth::user()->user_type !== 'da') {
            abort(403, 'Only Dealing Assistant can view eligible scholars.');
        }
    ...
    private function generateFormContent(Scholar $scholar, RegistrationForm $registrationForm)
    {
        ...
        $content .= "Generated by: " . Auth::user()->name . " (" . \App\Helpers\WorkflowHelper::getRoleFullForm('da') . ")\n";
