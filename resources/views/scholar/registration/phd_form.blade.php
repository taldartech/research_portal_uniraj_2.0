                    ...
                    <form method="POST" action="{{ route('scholar.registration.phd_form.store') }}" enctype="multipart/form-data" class="space-y-8">
                        ...
                        <div class="border-b border-gray-200 dark:border-gray-700 pb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <x-input-label for="hindi_name" :value="__('Hindi Name')" :required="true"/>
                                    <x-text-input id="hindi_name" name="hindi_name" type="text" class="mt-1 block w-full"
                                        :value="old('hindi_name', $scholar->hindi_name)" required />
                                    <x-input-error :messages="$errors->get('hindi_name')" class="mt-2" />
                                </div>
                        ...
                        <div class="border-b border-gray-200 dark:border-gray-700 pb-8">
                            ...
                            <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                                <h4 class="text-md font-medium text-gray-900 dark:text-gray-100 mb-4">PhD admission Information </h4>
