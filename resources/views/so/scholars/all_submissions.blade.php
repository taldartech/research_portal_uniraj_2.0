                                        ...
                                        @foreach ($scholars as $scholar)
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                    <a href="{{ route('so.scholars.show', $scholar) }}" class="text-blue-600 hover:text-blue-900">View</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                    @if($synopsis->status === 'pending_so_approval')
                                                        <a href="{{ route('so.synopses.approve', $synopsis) }}" class="text-indigo-600 hover:text-indigo-900">Review & Approve</a>
                                                    @else
