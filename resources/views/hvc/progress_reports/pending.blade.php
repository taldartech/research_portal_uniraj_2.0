                ...
                <div class="p-6 text-gray-900">
                    @if ($reports->isEmpty())
                        <div class="text-center py-12">
                            ...
                            <p class="mt-1 text-sm text-gray-500">There are no progress reports waiting for your approval.</p>
                        </div>
                    @else
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <div class="flex items-center space-x-3">
                                                    ...
                                                    <a href="{{ route('hvc.progress_reports.approve', $report) }}" class="text-indigo-600 hover:text-indigo-900">Review & Approve</a>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
