                        ...
                        @if($synopsis->status === 'pending_supervisor_approval')
                            ...
                            <div class="mb-6 p-4 bg-yellow-50 border-2 border-yellow-400 rounded-lg">
                                <div class="flex items-center mb-3">
                                    ...
                                    <h4 class="text-lg font-semibold text-yellow-800">Awaiting Supervisor Approval</h4>
                                </div>
                                <p class="text-sm text-yellow-700">
                                    This synopsis is currently pending supervisor approval. You can review the details below, but you cannot approve or reject it until the supervisor has reviewed and approved it first.
                                </p>
                                <div class="mt-3">
                            ...
                            <div class="text-center py-8">
                                <p class="text-gray-600 mb-4">This synopsis is waiting for supervisor approval before HOD review.</p>
                                <a href="{{ route('hod.synopsis.pending') }}"
                                   class="inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                    Back to Pending Synopses
                                </a>
                            </div>
                        @else
                            <!-- HOD Can Approve -->
                            ...
                            <div class="mb-6 p-4 bg-blue-50 border-2 border-blue-400 rounded-lg">
                                ...
                                <div class="bg-blue-100 p-3 rounded-md">
                                    <p class="text-sm text-blue-800">
                                        <strong>📋 Required for Approval:</strong> You must upload the DRC minutes file when approving this synopsis. This file will be forwarded to the Dean's Assistant along with your approval Remark.
                                    </p>
