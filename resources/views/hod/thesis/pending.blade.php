                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach ($thesisSubmissions as $thesis)
                                        <tr class="hover:bg-gray-50">
                                                    ...
                                                    <div class="flex-shrink-0 h-10 w-10">
                                                        <div class="h-10 w-10 rounded-full bg-indigo-100 flex items-center justify-center">
                                                            <span class="text-sm font-medium text-indigo-600">
                                                                {{ substr($thesis->scholar->user->name, 0, 2) }}
                                                            </span>
                                                        </div>
                                                    </div>
                                                    <div class="ml-4">
                                            ...
                                            <td class="px-6 py-4">
                                                <div class="text-sm font-medium text-gray-900">{{ Str::limit($thesis->title, 50) }}</div>
                                                @if($thesis->abstract)
                                                    <div class="text-sm text-gray-500 mt-1">{{ Str::limit($thesis->abstract, 100) }}</div>
                                                @endif
                                            </td>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <div class="flex space-x-2">
                                                    <a href="{{ route('hod.thesis.approve', $thesis) }}"
