                                        ...
                                        @foreach ($scholars as $scholar)
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                    <a href="{{ route('hod.scholars.show', $scholar) }}" class="text-blue-600 hover:text-blue-900">View</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                    @if($synopsis->status === 'pending_hod_approval')
                                                        <a href="{{ route('hod.synopsis.approve', $synopsis) }}" class="text-indigo-600 hover:text-indigo-900">Review & Approve</a>
                                                    @else
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        @foreach ($progressReports as $report)
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                    @if($report->status === 'pending_hod_approval')
                                                        <a href="{{ route('hod.progress_reports.approve', $report) }}" class="text-indigo-600 hover:text-indigo-900">Review & Approve</a>
                                                    @else
                                                        <a href="{{ route('hod.progress_reports.approve', $report) }}" class="text-blue-600 hover:text-blue-900">View Details</a>
                                                    @endif
                                                </td>
                                            </tr>
                                        @endforeach
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                    @if($thesis->status === 'pending_hod_approval')
                                                        <a href="{{ route('hod.thesis.approve', $thesis) }}" class="text-indigo-600 hover:text-indigo-900">Review & Approve</a>
                                                    @else
