<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Review Thesis Submission - Deputy Registrar Approval') }}
        </h2>
    </x-slot>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    @if($thesis->ar_remarks)
                        <div class="mb-6">
                            <h4 class="text-md font-medium text-gray-900 dark:text-gray-100 mb-2">AR Remarks</h4>
                            <div class="bg-pink-50 dark:bg-pink-900 p-3 rounded-lg">
                                <p class="text-sm text-gray-700 dark:text-gray-300">{{ $thesis->ar_remarks }}</p>
                            </div>
                        </div>
                    @endif
                    ...
                    <form method="POST" action="{{ route('dr.thesis.approve.store', $thesis) }}">
                        @csrf
                        ...
                        <div class="flex items-center justify-end mt-4">
                            <a href="{{ route('dr.thesis.pending') }}" class="text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100 mr-4">
                                Cancel
                            </a>
