        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mb-6">
                        <h3 class="text-lg font-medium text-gray-900">Capacity Increase Requests Pending DR Approval</h3>
                                    ...
                                    @foreach($requests as $request)
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <a href="{{ route('dr.capacity_requests.approve', $request) }}"
                    ...
                    @else
                        <div class="text-center py-12">
                            ...
                            <p class="mt-1 text-sm text-gray-500">There are no capacity increase requests pending DR approval at this time.</p>
                        </div>
                    @endif
                </div>
            </div>
