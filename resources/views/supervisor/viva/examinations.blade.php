        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                            ...
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                <thead class="bg-gray-50 dark:bg-gray-700">
                                    <tr>
                                        ...
                                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Examination Date</th>
                                ...
                                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                    @foreach($vivaExaminations as $vivaExamination)
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-gray-100">
                                                {{ $vivaExamination->scholar->user->name }}
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300">
                                                {{ Str::limit($vivaExamination->thesisSubmission->title, 50) }}
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300">
                                                {{ $vivaExamination->examination_date->format('M d, Y') }}
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300">
                                                {{ $vivaExamination->getExaminationTypeText() }}
                                            </td>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                @if($vivaExamination->isCompleted())
                                                    @if($vivaExamination->vivaReport && $vivaExamination->vivaReport->isCompleted())
                                                        <a href="{{ route('staff.viva.report.download', $vivaExamination->vivaReport) }}"
                                                           class="inline-flex items-center px-3 py-1.5 border border-transparent text-xs font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 mr-2">
                                                        ...
                                                        @if($vivaExamination->office_note_generated)
                                                            <a href="{{ route('staff.viva.office_note.download', $vivaExamination) }}"
                                                        ...
                                                        @endif
                                                    @else
                                                        <a href="{{ route('staff.viva.report.form', $vivaExamination) }}"
                    ...
                    @else
                        <p class="text-gray-500 dark:text-gray-400">No viva examinations found.</p>
                    @endif
                </div>
            </div>
        </div>
