                ...
                <div class="p-6 text-gray-900">
                    <div class="mb-6 flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-sm text-gray-600 mt-1">Showing all approved Pre-PhD Viva requests with scheduled dates from today onwards.</p>
                        </div>
                    ...
                    @if ($upcomingVivas->isEmpty())
                        <div class="text-center py-12">
                            ...
                            <p class="mt-1 text-sm text-gray-500">There are no scheduled Pre-PhD Viva dates for today or in the future.</p>
                        </div>
                    @else
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach ($upcomingVivas as $request)
                                        @php
                                            ...
                                            $isPast = $request->viva_date->isPast() && !$isToday;
                                        @endphp
