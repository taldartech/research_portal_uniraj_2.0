<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Pending Pre-PhD Viva Requests') }}
        </h2>
    </x-slot>
                ...
                <div class="p-6 text-gray-900">
                    @if ($requests->isEmpty())
                        <div class="text-center py-12">
                            <svg class="mx-auto h-5 w-24 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                            </svg>
                            <h3 class="mt-2 text-sm font-medium text-gray-900">No pending Pre-PhD Viva requests</h3>
                            <p class="mt-1 text-sm text-gray-500">There are no Pre-PhD Viva requests waiting for your approval.</p>
                        </div>
                    @else
                                    ...
                                    @foreach ($requests as $request)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <a href="{{ route('staff.pre_phd_viva.approve', $request) }}" class="text-indigo-600 hover:text-indigo-900">Review & Approve</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
