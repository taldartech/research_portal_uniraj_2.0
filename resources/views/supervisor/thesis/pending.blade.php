        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                                    ...
                                    @foreach($pendingTheses as $thesis)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <a href="{{ route('staff.thesis.approve', $thesis) }}" class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-300 mr-3">
                                                    Review & Approve
                                                </a>

                                                @if($thesis->submission_certificate_file)
                                                    <a href="{{ route('staff.thesis.certificate.download', $thesis) }}"
                                                ...
                                                @elseif(in_array($thesis->status, ['pending_so_approval', 'pending_ar_approval', 'pending_dr_approval', 'pending_hvc_approval', 'approved']))
                    ...
                    @else
                        <p class="text-gray-500 dark:text-gray-400">No pending thesis submissions.</p>
                    @endif
                </div>
            </div>
        </div>
