<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Pending Thesis Submissions for HOD Approval') }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                                    ...
                                    @foreach($pendingTheses as $thesis)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <a href="{{ route('drc.thesis.approve', $thesis) }}" class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-300">
                                                    Review & Approve
                                                </a>
                                            </td>
                                        </tr>
                    ...
                    @else
                        <p class="text-gray-500 dark:text-gray-400">No pending thesis submissions for HOD approval.</p>
                    @endif
                </div>
            </div>
        </div>
