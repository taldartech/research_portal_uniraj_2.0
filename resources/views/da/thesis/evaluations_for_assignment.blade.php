        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mb-6">
                        <h3 class="text-lg font-medium text-gray-900">Thesis Evaluations Ready for Assignment</h3>
                        <p class="text-sm text-gray-600">Assign experts for thesis evaluation</p>
                    </div>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach($theses as $thesis)
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm text-gray-900">{{ $thesis->created_at->format('M d, Y') }}</div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <a href="{{ route('da.thesis.assign_expert', $thesis) }}"
                    ...
                    @else
                        <div class="text-center py-12">
                            ...
                            <p class="mt-1 text-sm text-gray-500">There are no thesis evaluations ready for assignment at this time.</p>
                        </div>
                    @endif
                </div>
            </div>
