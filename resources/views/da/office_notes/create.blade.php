<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Generate Office Note for Registration') }}
        </h2>
    </x-slot>
                    ...
                    <div class="mb-8 bg-gray-50 dark:bg-gray-700 p-6 rounded-lg">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-900 dark:text-gray-100">{{ $scholar->user->name }}</p>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Email</label>
                                <p class="mt-1 text-sm text-gray-900 dark:text-gray-100">{{ $scholar->user->email }}</p>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Research Topic</label>
                                <p class="mt-1 text-sm text-gray-900 dark:text-gray-100">{{ $scholar->research_topic_title ?? 'Not specified' }}</p>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Supervisor</label>
                                <p class="mt-1 text-sm text-gray-900 dark:text-gray-100">{{ $scholar->supervisor_name ?? 'Not assigned' }}</p>
                            </div>
                        </div>
                    </div>

                    <!-- Office Note Generation Form -->
                    <form method="POST" action="{{ route('da.office_notes.generate.store', $scholar) }}">
                        @csrf
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="dated" name="dated" type="date" class="mt-1 block w-full"
                                                     value="{{ old('dated', now()->format('Y-m-d')) }}" required />
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <x-text-input id="supervisor_retirement_date" name="supervisor_retirement_date" type="date"
                                                     class="mt-1 block w-full" value="{{ old('supervisor_retirement_date') }}" />
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="co_supervisor_retirement_date" name="co_supervisor_retirement_date" type="date"
                                                     class="mt-1 block w-full" value="{{ old('co_supervisor_retirement_date') }}" />
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <x-text-input id="drc_approval_date" name="drc_approval_date" type="date"
                                                     class="mt-1 block w-full" value="{{ old('drc_approval_date') }}" />
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="commencement_date" name="commencement_date" type="date"
                                                     class="mt-1 block w-full" value="{{ old('commencement_date') }}" />
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <x-text-input id="registration_fee_receipt_number" name="registration_fee_receipt_number" type="text"
                                                     class="mt-1 block w-full" value="{{ old('registration_fee_receipt_number') }}" />
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="registration_fee_date" name="registration_fee_date" type="date"
                                                     class="mt-1 block w-full" value="{{ old('registration_fee_date') }}" />
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="enrollment_number" name="enrollment_number" type="text"
                                                     class="mt-1 block w-full" value="{{ old('enrollment_number', $scholar->enrollment_number) }}" />
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="supervisor_registration_page_number" name="supervisor_registration_page_number" type="text"
                                                     class="mt-1 block w-full" value="{{ old('supervisor_registration_page_number') }}" />
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <x-text-input id="supervisor_seats_available" name="supervisor_seats_available" type="number"
                                                     class="mt-1 block w-full" value="{{ old('supervisor_seats_available') }}" min="0" />
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="candidates_under_guidance" name="candidates_under_guidance" type="number"
                                                     class="mt-1 block w-full" value="{{ old('candidates_under_guidance') }}" min="0" />
