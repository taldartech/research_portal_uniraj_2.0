...
<div class="space-y-8">
    ...
    @if($pending_synopses->count() > 0)
        <div class="bg-white dark:bg-gray-700 rounded-lg shadow p-6">
            <h3 class="text-xl font-semibold mb-4 flex items-center">
                ...
                Pending Synopsis Approvals (Final Stage)
            </h3>
                    ...
                    <div class="border border-gray-200 dark:border-gray-600 rounded-lg p-4">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex space-x-2">
                                <a href="{{ route('hvc.synopsis.approve', $synopsis) }}"
    ...
    <div class="bg-white dark:bg-gray-700 rounded-lg shadow p-6">
        ...
        <div class="text-center py-8">
            ...
            <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-white">No recent approvals</h3>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                Approved synopses will appear here for reference.
            </p>
        </div>
    </div>
</div>
