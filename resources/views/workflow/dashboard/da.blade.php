...
<div class="space-y-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="bg-purple-500 rounded-lg p-6 text-white">
            <div class="flex items-center">
                ...
                <div>
                    <div class="text-2xl font-bold">{{ $statistics['generated_forms'] }}</div>
                    <div class="text-purple-100">Generated Forms</div>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="border border-gray-200 dark:border-gray-600 rounded-lg p-4">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex space-x-2">
                                <a href="{{ route('da.synopsis.approve', $synopsis) }}"
    ...
    <!-- Approved Synopses (Ready for Registration Form Generation) -->
    @if($approved_synopses->count() > 0)
        <div class="bg-white dark:bg-gray-700 rounded-lg shadow p-6">
            <h3 class="text-xl font-semibold mb-4 flex items-center">
                <svg class="w-6 h-6 mr-2 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                </svg>
                Approved Synopses (Ready for Registration Form)
            </h3>

            <div class="space-y-4">
                @foreach($approved_synopses as $synopsis)
                    <div class="border border-gray-200 dark:border-gray-600 rounded-lg p-4">
                        <div class="flex items-center justify-between">
                            <div>
                                <h4 class="font-medium text-gray-900 dark:text-white">
                            ...
                            <div class="flex space-x-2">
                                <a href="{{ route('registration.generate', $synopsis->scholar) }}"
